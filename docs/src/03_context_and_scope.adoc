...
| _Sistema de Donaciones_ | _Módulo que permite a los usuarios realizar donaciones mediante PayPal, enviándoles automáticamente un email de agradecimiento personalizado tras cada donación exitosa._
| _Correo Transaccional_ | _Servicio de envío de correos automáticos basado en nodemailer._
|===
...
===== donationservice
Servicio encargado de gestionar todo el flujo relacionado con las donaciones en la aplicación. Permite iniciar el pago mediante PayPal, capturar el pago una vez completado, y enviar automáticamente un correo de agradecimiento personalizado al usuario que ha donado, asegurando también la correcta separación entre entornos de prueba y producción.
...
| donationservice | Datos de donación y confirmación de pago | Captura del pago completado y envío de email de agradecimiento personalizado
|===
